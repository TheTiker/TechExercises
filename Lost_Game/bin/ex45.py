...
class Beach(Scene):
    ...
    def enter(self):
        print "\nYou wake up with blood and dirt all over your face."
        time.sleep(2)
...
class Hatch(Scene):
    ...
    def enter(self):
        ...
        print "There is a note on the table with several digits on it, but the last two numbers are unreadable."
        print "You type in the 4 8 15 16."
        time.sleep(5)
        ...
        if guess == digits:
            ...
            print "The whole island is blown up in a huge beam of bright white light!"
            return 'gameover'

        else:
            print "You did not enter anything else. As the timer is up, some weird hieroglyphs appear on it."
            print "Everything starts to shake and the whole islands explodes!"
            return 'gameover'
